...
Caffeine is a **natural stimulant** found in over 60 plant species, including coffee beans, tea leaves, cacao pods, and kola nuts. Plants evolved caffeine as a defense mechanism—it's actually a natural pesticide that paralyzes insects!

When you drink coffee, caffeine is absorbed through your stomach and small intestine within 45 minutes. It then crosses the blood-brain barrier and starts blocking **adenosine receptors**. Adenosine is your brain's "sleepiness molecule"—it builds up throughout the day and makes you feel tired. By blocking these receptors, caffeine tricks your brain into feeling alert.

But here's the catch: caffeine doesn't eliminate adenosine—it just temporarily blocks it. The adenosine keeps building up behind the scenes. When the caffeine wears off, all that accumulated adenosine floods your receptors at once, which is why you can crash hard after the effects fade.
...
Even 25mg can reduce your deep sleep by 20%! Research shows that caffeine consumed 6 hours before bed can cut total sleep time by over an hour—even if you don't *feel* like it's affecting you.
...
Caffeine content varies more than most people realize. Even the same drink from the same café can vary by 50% day to day!
...
- **Espresso has less caffeine than drip coffee** – It's more concentrated, but you drink far less volume. A single espresso (63mg) has less caffeine than an 8oz drip coffee (80mg).

- **"Decaf" isn't caffeine-free** – A cup of decaf still contains 2-15mg of caffeine. If you're highly sensitive or drink several cups, it adds up.

- **Tea caffeine depends on steep time** – The longer you steep, the more caffeine extracts. A 1-minute steep might yield 20mg; a 5-minute steep could hit 50mg from the same tea bag.

- **Cold brew isn't always stronger** – Despite the reputation, our Cold Brew (8oz) is 72mg. The "stronger" perception often comes from drinking larger portions.
...
This is where chronobiology meets your morning routine. Your body follows a **circadian rhythm**—a roughly 24-hour internal clock that regulates hormones, body temperature, and alertness.
...
| **9:30-11:30 AM** | Cortisol dips—perfect for your first coffee |
| **1:30-3:00 PM** | Post-lunch cortisol dip—ideal for second coffee |
...
**1. Adenosine Rebound**
Remember how caffeine blocks adenosine? Your body doesn't stop producing it—adenosine builds up behind the "blocked door." When caffeine wears off (it has a half-life, so it gradually decreases), that accumulated adenosine floods through. The result? A crash that feels worse than if you'd never had caffeine at all.
...
**5. Sleep Debt**
Using caffeine to push through tiredness doesn't eliminate your need for sleep—it just masks it temporarily. The underlying sleep debt remains and accumulates.
...
The app calculates your "sleep-ready time"—when caffeine levels will be low enough for quality sleep. If your bedtime is wrong, all predictions will be off.

**Example:** You want to be asleep by 11 PM but usually get in bed at 10:30 PM. Set bedtime to **11:00 PM**, not 10:30 PM.

**Bonus:** The app can send you alerts if you're approaching bedtime but your caffeine levels are still high—giving you time to adjust your evening plans.

### Do I need to log every single drink?

**Yes—consistency is key to accuracy!** 
...
1. **Enable Smart Daily Reminders** – The app only notifies you on days you haven't logged yet. No spam if you're already tracking!

2. **Use the Apple Watch app** – Single tap logging without pulling out your phone. Perfect for busy mornings.

3. **Build a streak** – The app tracks consecutive logging days. Many users find this surprisingly motivating—breaking a 30-day streak hurts!

4. **Log immediately** – The best predictor of logging success is logging *while drinking*, not "I'll do it later."
...
Go to **History** → **Add Entry** and set the exact time. Perfect for "I forgot to log my morning coffee and it's now 3 PM."
...
**1. Coffee Cat – Your Caffeine Avatar**

Coffee Cat is more than cute—it's an instant visual indicator of your caffeine state:
...
This number shows your **current estimated caffeine level**—not what you drank today, but what's actively circulating in your system right now.
...
You haven't logged anything yet—you're just exploring.
...
1. **Data quality** – Consistent logging means reliable patterns
2. **Habit formation** – It takes ~66 days to form a habit (not 21, as commonly believed)
3. **Self-awareness** – Streaks keep caffeine consumption top-of-mind
4. **Gamification** – Simple but effective motivation
...
- "I drank 12,400mg of caffeine in October—that's averaging 400mg/day"
- "August was lower—I was on vacation and more relaxed"
...
Why? **Cortisol**—your body's natural alertness hormone.
...
Here's the insight: if you drink coffee during this peak, caffeine competes with cortisol for the same mental effects. You're essentially stacking stimulants—and your body may develop tolerance faster because it doesn't need the caffeine when cortisol is already high.
...
HealthKit data stays in Apple's encrypted silo on your device. Mindful Coffee can only access what you explicitly permit, and Apple enforces these boundaries at the OS level. We couldn't read your heart rate even if we wanted to—you haven't granted that permission.

### How do CSV Import/Export work? (Pro)

Sometimes you need to break out of the app—for backups, analysis, or data portability.
...
1. **Device migration:** Export → get new phone → import
...
4. **Backup before experiments:** "I'm trying a caffeine detox—let me save my current data"
...
This is the most common issue—and it almost always comes down to calibration.
...
- Or: You might tolerate more caffeine than the app assumes—increase sleep threshold
...
- Or: You're more caffeine-sensitive—decrease sleep threshold
...
- Or: HealthKit imported duplicates—review imported entries
...
2. **Mindful Coffee has permission to read it**
   - Settings → Privacy → Health → Mindful Coffee
...
- Settings → Notifications → Mindful Coffee
...
- Settings → Focus → [Your focus] → Apps → Allow Notifications
...
In 1962, researchers first identified the CYP1A2 enzyme—and opened a window into understanding why your friend can drink espresso at 9 PM and sleep like a baby while you're staring at the ceiling.
...
Rather than blindly following a number, use Sleep Correlation data to find YOUR threshold—the amount above which your sleep measurably suffers. That's your personal "safe" limit.
...
Honesty time: Mindful Coffee is a model, and all models are wrong—but some are useful.
...
|--------|-------------|-------|
| Individual metabolism | ±2 hours | Half-life varies by person |
| Caffeine content | ±20-30% | Even same drink varies batch to batch |
| Absorption rate | ±30 minutes | Food in stomach slows absorption |
...
Probably not—unless you have a specific medical reason.
...
The goal isn't abstinence—it's **intentionality**.
...
Mindful Coffee is designed so that collecting your data isn't just against our policy—it's technically impossible.
...
When you grant HealthKit access, you're granting access to Apple's encrypted health database on your device. This data is protected by iOS at a system level—separate from regular app data, encrypted at rest, and controlled by you.

**Export = ownership:**

You can export all your data to CSV anytime. This is YOUR data. Take it anywhere, analyze it, delete it, share it with a doctor—whatever you want.
